...
public class allStudentResult extends javax.swing.JFrame {
            ...
            public void mousePressed(MouseEvent mouseEvent) {
                ...
                if (mouseEvent.getClickCount() == 2 && table.getSelectedRow() != -1) {
                    ...
                    if (numberOfRows > 0) {
                        ...
                        for (int i = 0; i < arr.length; i++) { // print all selected tasks
    ...
    private void jCheckBox_rankMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jCheckBox_rankMouseClicked
        // TODO add your handling code here:
        String sorting = "";
    ...
    }//GEN-LAST:event_jCheckBox_rankMouseClicked
